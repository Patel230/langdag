...
func (p *VertexProvider) Models() []types.ModelInfo {
	...
	return []types.ModelInfo{
		{ID: "claude-sonnet-4@20250514", Name: "Claude Sonnet 4 (Vertex)", ContextWindow: 200000, MaxOutput: 8192, ServerTools: st},
		{ID: "claude-opus-4@20250514", Name: "Claude Opus 4 (Vertex)", ContextWindow: 200000, MaxOutput: 8192, ServerTools: st},
		{ID: "claude-haiku-3-5@20241022", Name: "Claude Haiku 3.5 (Vertex)", ContextWindow: 200000, MaxOutput: 8192, ServerTools: st},
	}
}
